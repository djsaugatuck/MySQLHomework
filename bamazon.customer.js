	...
	inquirer.prompt([
		{
			type: 'input',
			name: 'item_id',
			message: 'Please enter the Item ID that you want.',
			...
			if (data.length == 0) {
				...
				if (quantity <= productData.stock_quantity) {
					...
					connection.query(updateQueryStr, function(err, data) {
						...
						console.log('Your oder has been placed. Your total price is $' + productData.price * quantity);
